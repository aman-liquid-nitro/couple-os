...
**Updated:** 2026-08-14 · **Milestone:** M5 met. **Every milestone's exit criteria are met and machine-checked.** V0_SCOPE's own done-checklist is **thirteen of fourteen** — debt 47's memory corpus was built and paid, debt 48 (no tool output in `ai_actions`) is what remains. Building the corpus found two ranking defects, debts 50 and 51, which is what a corpus is for. Not yet validated either way: that is the week of real use.
